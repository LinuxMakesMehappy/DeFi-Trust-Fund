...
describe("jupiter-kamino-stake", () => {
  ...
  it("Initializes the pool for Jupiter/Kamino integration", async () => {
  ...
  it("Allows users to stake with Jupiter/Kamino integration", async () => {
  ...
  it("Allows users to claim yields from Jupiter/Kamino", async () => {
  ...
  it("Allows users to unstake from Jupiter/Kamino", async () => {
    await program.methods
      .unstake()
      .accounts({
        user: user1.publicKey,
  ...
  it("Tests emergency pause functionality", async () => {
    await program.methods
      .emergencyPause("Testing emergency pause")
      .accounts({
        admin: admin.publicKey,
        pool: pool,
      })
  ...
  it("Tests emergency unpause functionality", async () => {
    await program.methods
      .emergencyUnpause()
      .accounts({
        admin: admin.publicKey,
